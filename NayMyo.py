...
banner = """\033[91m
<°°>======\033[93mMYANMAR CRACKER\033[91m======<°°>
...
\033[91m<=======\033[1;93mCREATED BY NAY MYO\033[91m=======>

\033[91m<=====\033[93mnaymyo15689.blogspot.com\033[91m=====>
"""
...
def ceknet():
    try:
    	os.system('reset')
        print internet
        print '\r\033[37;1m[\x1b[92m+\033[37;1m] \033[37;1mChecking Your {MYANMAR} Internet'
        time.sleep(2)
        toolbar_width = 25
        ...
        try:
            ...
            time.sleep(3.5)
            print '\033[37;1m]\033[35;1m ~>\033[31;1m Your Connection Is Bad'
            time.sleep(1.5)
            sys.exit()

    except KeyboardInterrupt:
    	time.sleep(3.5)
        exit('\n\033[37;1m[\x1b[92mx\033[37;1m] \033[31;1mProgram NAY MYO Exit\n')
        ...
        try:
            ...
            for pw in sandi:
                try:
                    ...
                    print '\033[37;1m[\033[32;1mx\033[37;1m] \033[31;1mConnection Error'
                    sys.exit()

        except IOError:
            print '\033[37;1m[\033[32;1mx\033[37;1m] \033[37;1mTry Create Your { MYANMAR } Password List Again'
            print '\033[37;1m[\033[32;1mx\033[37;1m] \033[37;1mGood Bye Friend See U Next Time'
            sys.exit()
